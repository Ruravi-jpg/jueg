...
AnimationList setText();
void setEnemy(Enemy& enemy);
std::vector<Tile> setTiles();
...
int main(void)
{
    ...
    AnimationList list(setText());
    player.setList(list);
    setEnemy(enemy);
    setEnemy(enemy2);
    setEnemy(enemy3);

    std::vector<Tile> tiles(setTiles());
    ...
    enemies[0].setPos(positionEn);
    
    Vector2 positionEn2 = { 150, 260 };
    enemies[1].setPos(positionEn2);
